...
import com.zzx.ordservice.mapper.TPayLogMapper;
import com.zzx.ordservice.service.TOrderService;
import com.zzx.ordservice.service.TPayLogService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.zzx.ordservice.util.HttpClient;
...
public class TPayLogServiceImpl extends ServiceImpl<TPayLogMapper, TPayLog> implements TPayLogService {
    ...
    public Map<String, Object> createWxQrcode(String orderNo) {
        try{
            ...
            e.printStackTrace();
            return null;
            //throw new zzxException(20001,"生成二维码失败");
        }
