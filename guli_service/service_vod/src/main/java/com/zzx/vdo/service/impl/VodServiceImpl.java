package com.zzx.vdo.service.impl;
...
import com.zzx.vdo.entity.ConstantVodUtils;
import com.zzx.vdo.entity.InitObject;
import com.zzx.vdo.service.VodService;
...
class VodServiceImpl implements VodService {
    ...
    public void removeAliyunVideoById(String id) {
        ...
        try {
            ...
            try {
                throw new zzxException(20001,"视频删除失败");
