package com.zzx.msmservice.service.impl;
...
@Component
public
class MsmServiceImpl implements MsmService {
    @Override
    public
    boolean sendMsm(HashMap<String, Object> map, String phone) {
        //发送短信的方法
            ...
            DefaultProfile profile = DefaultProfile.getProfile("default", "LTAI5t6Jqq8MGHrh6DVC4TjV", "4s806pazgztUkSOypPsuRUUpXOMc7c");
